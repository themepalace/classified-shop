...
<div class="product-wrapper">
    ...
    $i = 1;
    $the_query = classified_get_featured_aditems( $args );
    if ( ! empty( $the_query ) ) :
        ...
        <div class="four-col os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.6s" data-os-animation-duration="2s">
            <div class="product-item">
                <div class="prod-image">
                    <a href="<?php echo esc_url( get_permalink( $query->ID ) ); ?>">
                        <?php  
                        if ( has_post_thumbnail( $query->ID ) ) :
                            $image = get_the_post_thumbnail( $query->ID, 'post-thumbnail', array( 'alt' => $query->post_title ) );
                            echo $image;
                        else :
                    ...
                    <?php
                    $tp_cat            = wp_get_post_terms($query->ID, $tp_taxonomy, array("fields" => "ids"));
                    ...
                    $tp_location       = wp_get_post_terms( $query->ID, $tp_location_taxonomy, array("fields" => "all") );
                ...
                <div class="prod-details">
                    <h3><a href="<?php echo esc_url( get_permalink( $query->ID ) ); ?>"><?php echo esc_html( $query->post_title ); ?></a></h3>
                ...
                <div class="prod-footer">
                    ...
                    <div class="prod-price">
                        <h4>
                            <?php 
                            $tp_price = get_post_meta( $query->ID, '_aditem_price', true );
