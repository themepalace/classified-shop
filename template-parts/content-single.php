		...
		<div class="featured-image">
			<?php 
          	if ( has_post_thumbnail() ) :
                the_post_thumbnail( get_the_id(), $size = 'large', array( 'alt' => get_the_title() ) );
              endif; 
          ?>
		...
		<div class="archive-contents">
			<?php
				the_content( sprintf(
					...
					wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'classified-shop' ), array( 'span' => array( 'class' => array() ) ) ),
